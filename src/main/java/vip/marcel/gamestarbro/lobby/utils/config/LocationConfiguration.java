...
public class LocationConfiguration implements ConfigHandler {

    private final Lobby plugin;

    private final File folder = new File("plugins/Lobby");
    private final File file = new File(this.folder, "locations.yml");

    private YamlConfiguration configuration = YamlConfiguration.loadConfiguration(this.file);

    public LocationConfiguration(Lobby plugin) {
        this.plugin = plugin;
